        ...
        "configs": {
            "current": {
                ...
                "corners": [
                    ...
                    {"id": 8, "name": "Malmedy", "start": 0.208, "end": 0.225},
                    {"id": 9, "name": "Bruxelles (Rivage)", "start": 0.225, "end": 0.260},
                    {"id": 10, "name": "Jacky Ickx Corner", "start": 0.330, "end": 0.352},
                    {"id": 11, "name": "Pouhon 1", "start": 0.418, "end": 0.442},
                    {"id": 12, "name": "Pouhon 2", "start": 0.442, "end": 0.472},
                    {"id": 13, "name": "Fagnes 1 (Piff Paff)", "start": 0.488, "end": 0.498},
                    {"id": 14, "name": "Fagnes 2", "start": 0.498, "end": 0.508},
                    {"id": 15, "name": "Campus", "start": 0.710, "end": 0.722},
                    {"id": 16, "name": "Paul Frere", "start": 0.722, "end": 0.752},
                    {"id": 17, "name": "Blanchimont 1", "start": 0.820, "end": 0.832},
                    {"id": 18, "name": "Blanchimont 2", "start": 0.832, "end": 0.842},
                    {"id": 19, "name": "Bus Stop 1", "start": 0.928, "end": 0.942},
                    {"id": 20, "name": "Bus Stop 2", "start": 0.942, "end": 0.955},
                ],
            },
        },
    },
