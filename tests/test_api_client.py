...
class TestSubmissionResult:
    ...
    def test_submission_result_defaults(self):
        ...
        result = SubmissionResult(status=SubmissionStatus.SUCCESS, message="Test message")
    ...
    def test_submission_result_with_lap_id(self):
        ...
        result = SubmissionResult(status=SubmissionStatus.SUCCESS, message="Lap submitted", lap_id="lap-123")
